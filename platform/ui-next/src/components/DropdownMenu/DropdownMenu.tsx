...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'max-h-[calc(100vh-200px)] bg-popover text-popover-foreground border-input/50 z-50 min-w-[8rem] overflow-hidden overflow-y-auto rounded border p-1 shadow-md',
