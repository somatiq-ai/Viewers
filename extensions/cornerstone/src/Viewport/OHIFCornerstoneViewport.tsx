...
import ViewportCloseButton from '../components/ViewportCloseButton';
import ViewportClearMeasurementsButton from '../components/ViewportClearMeasurementsButton';
  ...
  (
    ...
    useEffect(() => {
      ...
      viewportActionCornersService.addComponent({
        ...
        indexPriority: 110, // Lower priority than close button so it appears before it
      });
      ...
      viewportActionCornersService.addComponent({
        ...
        location: viewportActionCornersService.LOCATIONS.topRight,
        indexPriority: 100, // High priority to appear first
      });
